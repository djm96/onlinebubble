!(function (a) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = a();
        ...
        var b;
        (b = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this), (b.StackBlur = a());
    }
})(function () {
                ...
                function (a, b, c) {
                    ...
                    function g(a, b, c, d, e, f) {
                        ...
                        var S = k[f],
                            T = l[f];
                        for (h = 0; h < e; h++) {
                            for (y = z = A = B = q = r = s = t = 0, u = L * (C = H[o]), v = L * (D = H[o + 1]), w = L * (E = H[o + 2]), x = L * (F = H[o + 3]), q += M * C, r += M * D, s += M * E, t += M * F, O = N, i = 0; i < L; i++)
                            ...
                            for (Q = N, R = P, g = 0; g < d; g++)
                                (H[o + 3] = F = (t * S) >> T),
                                    0 != F ? ((F = 255 / F), (H[o] = ((q * S) >> T) * F), (H[o + 1] = ((r * S) >> T) * F), (H[o + 2] = ((s * S) >> T) * F)) : (H[o] = H[o + 1] = H[o + 2] = 0),
                                    (q -= u),
                                    (r -= v),
                                    (s -= w),
                                    (t -= x),
                        ...
                        for (g = 0; g < d; g++) {
                            for (
                                z = A = B = y = r = s = t = q = 0, o = g << 2, u = L * (C = H[o]), v = L * (D = H[o + 1]), w = L * (E = H[o + 2]), x = L * (F = H[o + 3]), q += M * C, r += M * D, s += M * E, t += M * F, O = N, i = 0;
                                i < L;
                                i++
                            )
                                (O.r = C), (O.g = D), (O.b = E), (O.a = F), (O = O.next);
                            ...
                            for (o = g, Q = N, R = P, h = 0; h < e; h++)
                                (m = o << 2),
                                    (H[m + 3] = F = (t * S) >> T),
                                    F > 0 ? ((F = 255 / F), (H[m] = ((q * S) >> T) * F), (H[m + 1] = ((r * S) >> T) * F), (H[m + 2] = ((s * S) >> T) * F)) : (H[m] = H[m + 1] = H[m + 2] = 0),
                                    (q -= u),
                                    (r -= v),
                                    (s -= w),
                                    (t -= x),
                    ...
                    function i(a, b, c, d, e, f) {
                        ...
                        var O = k[f],
                            P = l[f];
                        for (h = 0; h < e; h++) {
                            for (w = x = y = q = r = s = 0, t = H * (z = D[o]), u = H * (A = D[o + 1]), v = H * (B = D[o + 2]), q += I * z, r += I * A, s += I * B, K = J, i = 0; i < H; i++) (K.r = z), (K.g = A), (K.b = B), (K = K.next);
                            for (i = 1; i < H; i++) (m = o + ((F < i ? F : i) << 2)), (q += (K.r = z = D[m]) * (C = H - i)), (r += (K.g = A = D[m + 1]) * C), (s += (K.b = B = D[m + 2]) * C), (w += z), (x += A), (y += B), (K = K.next);
                        ...
                        for (g = 0; g < d; g++) {
                            for (x = y = w = r = s = q = 0, o = g << 2, t = H * (z = D[o]), u = H * (A = D[o + 1]), v = H * (B = D[o + 2]), q += I * z, r += I * A, s += I * B, K = J, i = 0; i < H; i++)
                                (K.r = z), (K.g = A), (K.b = B), (K = K.next);
                            for (n = d, i = 1; i <= f; i++)
                                (o = (n + g) << 2), (q += (K.r = z = D[o]) * (C = H - i)), (r += (K.g = A = D[o + 1]) * C), (s += (K.b = B = D[o + 2]) * C), (w += z), (x += A), (y += B), (K = K.next), i < G && (n += d);
                    ...
                    b.exports = { image: d, canvasRGBA: f, canvasRGB: h, imageDataRGBA: g, imageDataRGB: i };
                },
                {},
            ],
        },
